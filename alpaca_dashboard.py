...
days = st.sidebar.number_input('Please enter the number of previous trading days you would like to see',30)
...
st.write('PandL = {}'.format(pandl.profit.iloc[-1]))
st.write('Symbols {}'.format(pandl.symbol.unique()))
#     # print profit report
